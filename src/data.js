...
export const menuItems = [
    ...
    { key: 'base_a', name: '含氮鹼基', scale: 0.15, imageOffset: { x: 4, y: 0 }, magnets: [{ x: -1, y: -28 }, { x: -36, y: -1 }, { x: 0, y: 28 }, { x: 40, y: -1 }] },
    { key: 'base_t', name: '含氮鹼基', scale: 0.15, imageOffset: { x: 4, y: 0 }, magnets: [{ x: -35, y: -1 }, { x: -1, y: 30 }, { x: -1, y: -30 }, { x: 25, y: -1 }] },
    { key: 'base_c', name: '含氮鹼基', scale: 0.23, imageOffset: { x: 3, y: -1 }, magnets: [{ x: -36, y: -1 }, { x: -1, y: -30 }, { x: 0, y: 29 }, { x: 21, y: 2 }] },
    { key: 'base_g', name: '含氮鹼基', scale: 0.15, imageOffset: { x: 6, y: -1 }, magnets: [{ x: -36, y: -1 }, { x: -1, y: -29 }, { x: -1, y: 26 }, { x: 44, y: 0 }] },
    { key: 'base_u', name: '含氮鹼基', scale: 0.15, imageOffset: { x: 5, y: -1 }, magnets: [{ x: -1, y: -29 }, { x: -34, y: -3 }, { x: -1, y: 26 }, { x: 26, y: -1 }] }
];
